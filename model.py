...
class QFunction:
    ...
    def _model(self, X, reuse=False):
        ...
        with tf.variable_scope(self.scope, reuse=reuse):
            if cfg.model == "capsule":
                conv1 = conv(X, [28, 28, cfg.state_length, 256], [1, 1, 1, 1], padding="VALID", activation_fn=tf.nn.relu)
                ...
                conv1 = conv(X, [4, 4, cfg.state_length, 32], [1, 4, 4, 1], activation_fn=tf.nn.relu, scope="conv1")
